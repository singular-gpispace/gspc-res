...
namespace pnetc
{
  namespace op
  {
    namespace singular_template
    {
      ...
      {
        const we::type::literal::control & disable (::boost::get< we::type::literal::control > (_pnetc_input.value (std::list<std::string> (1, "disable"))));
        ...
        unsigned long M;
        unsigned long N;
        ::pnetc::op::singular_template::Generate (disable, res, library_name, base_filename, input, syz, drainage, len, Res, Input, c, addFill, M, N);
