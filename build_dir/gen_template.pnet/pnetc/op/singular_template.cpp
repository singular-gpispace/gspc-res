  ...
  namespace op
  {
    namespace singular_template
    {
        ...
        )
      {
        ...
        std::string s;
        ::pnetc::op::singular_template::ADD (library_name, base_filename, input, range, s);
  ...
  namespace op
  {
    namespace singular_template
    {
        ...
        )
      {
        ...
        int counter;
        ::pnetc::op::singular_template::All_Lead (init, library_name, base_filename, C, OUTPUT, counter);
        _pnetc_output.bind_and_discard_ref (std::list<std::string> (1, "C"), C);
        _pnetc_output.bind_and_discard_ref (std::list<std::string> (1, "OUTPUT"), OUTPUT);
  ...
  namespace op
  {
    namespace singular_template
    {
        ...
        )
      {
        ...
        ::pnetc::op::singular_template::Enable (N, IN, r, out);
